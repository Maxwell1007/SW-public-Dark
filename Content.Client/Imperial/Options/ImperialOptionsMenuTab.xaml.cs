...
public sealed partial class ImperialOptionsMenuTab : Control
{
    ...
    public ImperialOptionsMenuTab()
    {
        ...
        void AddOptionButton(string name, int currentValue, Action<int> callback, Action<OptionButton> initAction)
        {
            var hBox = new BoxContainer
            {
                ...
                Children =
                {
                    ...
                    new OptionButton { Name = "OptButton" }
                }
            };

            var optionButton = (OptionButton) hBox.GetChild(2);
            optionButton.MinSize = new Vector2(300, 0);

            initAction(optionButton);
            optionButton.SelectId(currentValue);
            ...
            KeybindsContainer.AddChild(hBox);
        }
        ...
        AddOptionButton(
            ...
            _cfg.GetCVar(CCVars.ParryReadySoundType),
            id =>
            {
                _cfg.SetCVar(CCVars.ParryReadySoundType, id);
                _cfg.SaveToFile();
            },
            opt =>
            {
                opt.AddItem(Loc.GetString("ui-options-parry-sound-none"), 0);
                opt.AddItem(Loc.GetString("ui-options-parry-sound-ding"), 1);
                opt.AddItem(Loc.GetString("ui-options-parry-sound-pop"), 2);
                opt.AddItem(Loc.GetString("ui-options-parry-sound-tick1"), 3);
                opt.AddItem(Loc.GetString("ui-options-parry-sound-tick2"), 4);
            }
        );
